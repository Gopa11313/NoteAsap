        ...
        if (imageUrl != null) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try{
                    ...
                    withContext(Dispatchers.Main) {
                        Toast.makeText(this@ImageUploadActivity, "error", Toast.LENGTH_SHORT).show()
                        Log.d("Error uploading image ", ex.toString())
                        Toast.makeText(this@ImageUploadActivity, ex.localizedMessage, Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
