...
public abstract interface BookamarkApi {
    ...
    @retrofit2.http.Path(value = "id")
    java.lang.String userId, @org.jetbrains.annotations.NotNull()
    @retrofit2.http.Field(value = "noteId")
    java.lang.String noteId, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.example.noteasap.response.BookmarkResponse>> p3);
}